...
BuyMeACoffee          : https://buymeacoffee.com/appydave
Scenery Video Editor  : https://scenery.video/?rfsn=7974818.3944905
Kajabi                : https://app.kajabi.com/r/jMLhRhFi

Title                 : 16 Awesome MidJourney Alternatives After Your Account Ban

Video URL             : https://youtu.be/068NXAFE4Cs

Chapters:

00:00 Introduction
00:13 The Shocking Ban
09:52 16 New Art Generators
19:20 Conclusion and Future Plans

# Transcript Summary

AppyDave shares his frustrating experience with Mid Journey, where he was banned and lost a $300 subscription without clear reasons or proper support. Despite reaching out and explaining his situation, he received no helpful response from Mid Journey. As a result, he explores 16 alternatives to Mid Journey for AI art generation.

Key points:

Long-term user of Mid Journey, created thousands of images for YouTube.
Banned after renewing his subscription, with accusations of violations he denies.
Explored other AI art tools: Night Cafe, Idiogram, OpenArt, Designs AI, Blue Willow, Adobe Firefly, Photor, Crayon, Dream Studio, Imagine, Playground, Hotpot, Lexica, Microsoft Co-Pilot, Leonardo AI, and Diffusion B.
Detailed comparisons of each tool, highlighting their strengths and weaknesses.
Encourages viewers to explore these alternatives and asks for feedback on which tools to review in-depth.
...
AppyDave shares his experiences with Mid Journey, mentioning a recently renewed $300 subscription.
He was banned unexpectedly and received no clear communication from Mid Journey support.
Issues with Mid Journey:

Dave outlines his frustration with the ban, which he believes to be a misdiagnosis.
Despite contacting Mid Journey support, he received vague responses citing terms of service violations.
Potential Causes and Speculations:

Dave investigates possible reasons for the ban, including IP and email bans due to international travel.
He draws parallels to a previous issue with an American e-commerce platform where his ban was later reversed.
Exploration of Alternatives:

Dave decides to explore other AI art generators, reviewing 16 alternatives to Mid Journey.
He uses three reference images, runs them through various AI art generators, and evaluates the results.
Detailed Reviews of AI Art Generators:

Night Cafe: Offers stable diffusion or DALE-3, with print-on-demand and various art styles.
Idiogram: Features preset image styles, 3D rendering, and text integration.
OpenArt: Known for anime characters and image upscaling.
Designs AI: Includes tools like logo maker, video maker, and speech maker.
Blue Willow and Adobe Firefly: Both produce high-quality images, with Adobe integrating ethical AI practices.
Photor: Provides photo enhancement, background removal, and realistic human face generation.
Dream Studio: Utilizes stability AI with capabilities like image-to-image generation.
Imagine Art: Known for background removal and advanced configuration.
Playground and Hotpot: Offer versatile tools for photo editing and text writing.
Lexica and Microsoft Co-Pilot: Lexica is an image search engine with customization tools; Co-Pilot uses DALE-3 for image generation.
Leonardo AI and Diffusion B: Leonardo features advanced tools like Control Net; Diffusion B is a local stable diffusion implementation.
Conclusion:

Despite the ban, Dave finds value in exploring various AI art generators.
He encourages viewers to like, subscribe, and leave comments for future video topics.
...
Hi, I'm AppyDave and I'm going to share what happened.
...
But last year, I did end up switching a fair bit over to DALE-3
...
And in my opinion, DALE-3, while not as good as Mid Journey, was a worthy contender.
...
and we'll drag them straight into DALE-3.
Once they're in DALE-3 we can actually ask DALE-3 to tell us what the image is about
but I'll give it a little bit extra context by giving it the original mid-journey prompt as well
and then when we run it through DALE-3 we get a prompt like this.
...
As for Microsoft Copilot it's essentially DALE-3.
...
We'll start by dragging the reference image over into DALE-3.
...
This tool you can use stable diffusion or DALE-3.
...
So Microsoft Co-Pilot which is DALE-3.
...
So with the image we've dragged it into DALE-3.
The original prompt was actually quite simple.
It was an angel lion emerging from ash.
But with the image being dragged into DALE-3,
...
50 prompts, 4 images per prompt for mid-journey and 4 images per prompt for DALE-3.
